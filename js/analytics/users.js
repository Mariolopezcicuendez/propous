...
$(document).ready(function() 
{
  ...
  if (action === 'detail')
  {
    ...
    $('.title_zone').text('Usuarios' + title_by_group+'  '+ ((analytics_detail_day !== '') ? analytics_detail_day + "/" : analytics_detail_day ) + analytics_detail_month + "/" + analytics_detail_year);
...
function success_detail(json)
{
  ...
  $.each(data = json.result, function (i) 
  {
    ...
    var td_name = $("<td></td>").addClass('analitycs_table_detail_tbody_td').text(data[i].name);
