...
$(document).ready(function() 
{
  ...
  if (search_done())
  {
    ...
    if ((local_storage_item !== "") && (local_storage_item !== "null") && (local_storage_item !== null) && (typeof local_storage_item !== "undefined"))
    {
      var search = JSON.parse(local_storage_item);

      var search_categories_exists = (typeof search.s_categories !== "undefined" && search.s_categories !== null && search.s_categories !== '');
      ...
      // Busqueda simple
      if ((!advanced_searching) && (typeof search.s_search !== "undefined" && search.s_search !== null && search.s_search !== ''))
      {
        put_simple_search_data_in_search_box();
      }
...
{
  var local_storage_item = localStorage.getItem("search_object");
  return (typeof local_storage_item !== "undefined" && local_storage_item !== null && local_storage_item !== '');
}
...
function success_get_main_props(data)
{
...
function stilize_datatable()
{
  ...
  $('select[name=prop_main_table_props_length]').addClass("form-control").addClass("input_inline_3_elements_full").addClass("prop_list_select_length");
}
...
{
  $('img.prop_list_images_img_action_favorite[favorite_id='+data.result+']').removeClass('prop_list_images_img_action_favorite_on').addClass('prop_list_images_img_action_favorite_off');
  $('img.prop_list_images_img_action_favorite[favorite_id='+data.result+']').attr("src",baseurl + "/assets/icons/actions/favorite_off.png");
  $('img.prop_list_images_img_action_favorite[favorite_id='+data.result+']').attr("title",lang('p_favorite_off'));
  $('img.prop_list_images_img_action_favorite[favorite_id='+data.result+']').attr("favorite_id","");
