<div class='content_page_left content'>
  ...
  <input type='hidden' id='cms_action' value='edit'>
   ...
   <div class="div_content_info form-group page-cms">
      ...
      <?php if ($action === 'new') : ?>
        <h3 class='title_zone'>Nueva Categoría</h3>
      <?php endif; ?>
      <?php if ($action === 'edit') : ?>
        <h3 class='title_zone'>Categoría <?php echo $data->id; ?></h3>
      <?php endif; ?>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              ...
              <?php if (file_exists(BASEPATH . '../assets/icons/category/'.$name_icon)) : ?>
                <img class='form-control cms_icon_edit' title='assets/icons/category/<?php echo $name_icon; ?>' src='<?php echo $this->config->item('file_base_url_relative'); ?>assets/icons/category/<?php echo $name_icon; ?>'></img>
              <?php else : ?>
                <img class='form-control cms_icon_edit' title='assets/icons/category/@NO_ICON.png' src='<?php echo $this->config->item('file_base_url_relative'); ?>assets/icons/category/@NO_ICON.png'></img>
              <?php endif; ?>
              <?php if (($user_data['rol'] === 'admin') || ($user_data['rol'] === 'superadmin')) : ?>
