<div class='content_page_left content'>
  ...
  <input type='hidden' id='cms_action' value='edit'>
   ...
   <div class="div_content_info form-group page-cms">
      ...
      <?php if ($action === 'new') : ?>
        <h3 class='title_zone'>Nueva Sociality</h3>
      <?php endif; ?>
      <?php if ($action === 'edit') : ?>
        <h3 class='title_zone'>Sociality <?php echo $data->id; ?></h3>
      <?php endif; ?>
      ...
      <div class='cms_main_table_div col-md-12 content'>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
              <?php $name_icon = substr(strtolower($data->tag),1).".png"; ?>
              <?php if (file_exists(BASEPATH . '../assets/icons/sociality/'.$name_icon)) : ?>
                <img class='form-control cms_icon_edit' title='assets/icons/sociality/<?php echo $name_icon; ?>' src='<?php echo $this->config->item('file_base_url_relative'); ?>assets/icons/sociality/<?php echo $name_icon; ?>'></img>
              <?php else : ?>
                <img class='form-control cms_icon_edit' title='assets/icons/sociality/@NO_ICON.png' src='<?php echo $this->config->item('file_base_url_relative'); ?>assets/icons/sociality/@NO_ICON.png'></img>
              <?php endif; ?>
              <?php if (($user_data['rol'] === 'admin') || ($user_data['rol'] === 'superadmin')) : ?>
              <input type="file" data-buttonText="Subir nuevo icono" name="upload" data-classButton="btn btn-primary" data-input="false" class='cms_icon_inputfile filestyle'/>
              <?php endif; ?>
            </div>
          </div>
          <?php echo form_close(); ?>
