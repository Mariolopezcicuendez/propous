		...
		<div class='content_viewprofile_body col-md-12 content panel-body'>
			...
			<div class="form-group">
				...
				<div class='content_viewprofile_data_left col-md-2'>
					<img class='img-rounded' style='width:<?php echo MAIN_PHOTO_WIDTH; ?>px; height:<?php echo MAIN_PHOTO_HEIGHT; ?>px;' src='<?php echo $this->config->item('file_base_url_relative'); ?>assets/photos/no_photo.png' class='content_viewprofile_main_photo'></img>
				</div>
