	...
	<div class='content_editprofile_data content panel panel-default'>
		...
		<div class='content_editprofile_body col-md-12 content panel-body'>
			...
			<div class="form-group">
				...
				<div class='content_editprofile_data_left col-md-2'>
					<img style='width:<?php echo MAIN_PHOTO_WIDTH; ?>px; height:<?php echo MAIN_PHOTO_HEIGHT; ?>px;' src='<?php echo $this->config->item('file_base_url_relative'); ?>assets/photos/no_photo.png' class='content_editprofile_main_photo'></img>
				</div>
		...
		<div class="form-group">
			...
			<div class='content_editprofile_photos_right col-md-10'>
				...
				<form class="editprofile_upload_photo_form form-horizontal" enctype="multipart/form-data" role="form">
